...
<?php
   ...
   if(isset($_POST['submit'])){
    ...
    $emailaddressquery = "select * from formregister where emailaddress='$emailaddress'";
    ...
    if($emailaddresscount>0){
        ...
        if($password === $confirmpassword){
            ...
            $insertquery = "INSERT INTO `formregister` (`first`, `last`, `emailaddress`, `password`, `confirmpassword`) 
        ...
        <div class="details">
            ...
            <div class="txt">
                ...
                <form action="#" method="POST" class="signup">
                    ...
                    <div class="fill">
                        <input type="text" name="emailaddress" placeholder="Email Address" required autocomplete="off">
                    </div>
                    <div class="fill">
