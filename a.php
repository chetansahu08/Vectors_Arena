...
<?php
   ...
   if(isset($_POST['submit'])){
       ...
       $emailaddress_search = "select * from formregister where emailaddress = '$emailaddress'";
        ...
        <div class="details">
            ...
            <div class="txt">
                <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST" class="login">
                    ...
                    <div class="fill">
                        <input type="text" name="emailaddress" placeholder="Email-Id" required autocomplete="off">
                    </div>
